...
SECTION( ".vector_table" ) IRQHandler VectorTable[] = {
		(IRQHandler) & initial_main_stack,/* The initial stack pointer */
		(IRQHandler) ( (uint32_t) Reset_Handler + 1 ),
		(IRQHandler) ( (uint32_t) NMI_Handler + 1 ),
		(IRQHandler) ( (uint32_t) HardFault_Handler + 1 ),
		(IRQHandler) ( (uint32_t) MemManage_Handler + 1 ),
		(IRQHandler) ( (uint32_t) BusFault_Handler + 1 ),
		(IRQHandler) ( (uint32_t) UsageFault_Handler + 1 ),
		NULL,
		NULL,
		NULL,
		NULL,
		(IRQHandler) ( (uint32_t) SVC_Handler + 1 ),
		(IRQHandler) ( (uint32_t) DebugMon_Handler + 1 ),
		NULL,
		(IRQHandler) ( (uint32_t) PendSV_Handler + 1 ),
		(IRQHandler) ( (uint32_t) SysTick_Handler + 1 ),
		(IRQHandler) ( (uint32_t) WWDG_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) PVD_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) TAMPER_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) RTC_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) FLASH_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) RCC_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) EXTI0_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) EXTI1_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) EXTI2_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) EXTI3_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) EXTI4_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) DMA1_Channel1_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) DMA1_Channel2_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) DMA1_Channel3_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) DMA1_Channel4_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) DMA1_Channel5_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) DMA1_Channel6_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) DMA1_Channel7_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) ADC1_2_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) CAN1_TX_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) CAN1_RX0_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) CAN1_RX1_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) CAN1_SCE_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) EXTI9_5_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) TIM1_BRK_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) TIM1_UP_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) TIM1_TRG_COM_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) TIM1_CC_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) TIM2_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) TIM3_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) TIM4_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) I2C1_EV_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) I2C1_ER_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) I2C2_EV_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) I2C2_ER_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) SPI1_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) SPI2_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) USART1_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) USART2_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) USART3_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) EXTI15_10_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) RTC_Alarm_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) OTG_FS_WKUP_IRQHandler + 1 ),
		NULL,
		NULL,
		NULL,
		NULL,
		...
		NULL,
		NULL,
		(IRQHandler) ( (uint32_t) TIM5_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) SPI3_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) UART4_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) UART5_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) TIM6_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) TIM7_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) DMA2_Channel1_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) DMA2_Channel2_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) DMA2_Channel3_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) DMA2_Channel4_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) DMA2_Channel5_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) ETH_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) ETH_WKUP_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) CAN2_TX_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) CAN2_RX0_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) CAN2_RX1_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) CAN2_SCE_IRQHandler + 1 ),
		(IRQHandler) ( (uint32_t) OTG_FS_IRQHandler )
};
